...
VALUES (1, 'Juan', 'Pérez', 'GIDATI', 'juan.perez@unicauca.edu.co');

INSERT INTO `Docentes` (`idDocente`, `nombre_docente`, `apellidos_docente`, `nombre_grupo`, `correo`) 
VALUES (2, 'María', 'López', 'GIDATI', 'maria.lopez@unicauca.edu.co');

INSERT INTO `Docentes` (`idDocente`, `nombre_docente`, `apellidos_docente`, `nombre_grupo`, `correo`) 
VALUES (3, 'Carlos', 'Rodríguez', 'GIDATI', 'carlos.rodriguez@unicauca.edu.co');
...
VALUES (1, 1, 1, 1, '2023-01-01', NULL);

INSERT INTO `Historicos` (`idHistoricos`, `idDocente`, `idRol`, `activo`, `fechaInicio`, `fechaFin`) 
VALUES (2, 2, 2, 1, '2023-01-01', NULL);

INSERT INTO `Historicos` (`idHistoricos`, `idDocente`, `idRol`, `activo`, `fechaInicio`, `fechaFin`) 
VALUES (3, 3, 3, 1, '2023-01-01', NULL);

-- FormatosA
INSERT INTO `FormatosA` (`idFormatoA`, `nombre_director`, `objetivo_general`, `objetivos_especificos`, `titulo`, `idDocente`) 
VALUES (1, 'Juan Pérez', 'Desarrollar una aplicación web para la gestión de formatos de propuestas de trabajo de grado', 
'1. Diseñar la arquitectura de la aplicación\n2. Implementar la interfaz de usuario\n3. Desarrollar la lógica de negocio', 
'Sistema de Gestión de Formatos de Propuestas de Trabajo de Grado', 1);
