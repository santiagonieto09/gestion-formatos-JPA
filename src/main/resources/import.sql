...
-- Docentes
INSERT INTO `Docentes` (`idDocente`, `nombre_docente`, `apellidos_docente`, `nombre_grupo`, `correo`) VALUES (1, 'Juan', 'Pérez', 'GIDATI', 'juan.perez@unicauca.edu.co');

INSERT INTO `Docentes` (`idDocente`, `nombre_docente`, `apellidos_docente`, `nombre_grupo`, `correo`) VALUES (2, 'María', 'López', 'GIDATI', 'maria.lopez@unicauca.edu.co');

INSERT INTO `Docentes` (`idDocente`, `nombre_docente`, `apellidos_docente`, `nombre_grupo`, `correo`) VALUES (3, 'Carlos', 'Rodríguez', 'GIDATI', 'carlos.rodriguez@unicauca.edu.co');
...
-- Observaciones
INSERT INTO `Observaciones` (`idObservacion`, `observacion`, `fecha_registro_observacion`, `idEvaluacion`) VALUES (1, 'Se requiere mejorar la redacción del objetivo general', '2023-04-16', 1);

INSERT INTO `Observaciones` (`idObservacion`, `observacion`, `fecha_registro_observacion`, `idEvaluacion`) VALUES (2, 'Agregar más detalles sobre la metodología a utilizar', '2023-04-16', 1);